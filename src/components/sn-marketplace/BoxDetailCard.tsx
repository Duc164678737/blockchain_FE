...
const BoxDetailCard = ({ data, className, buttonProps, ...otherProps }: BoxCardProps) => {
    ...
    <Box className={clsx(classes.root, className)}>
      <Stack className={clsx(classes.container)} {...otherProps}>
        ...
        <AppTypography className={classes.price}>
          <AppTrans i18nKey={getLabel("fmPriceBox", { total: data.price })} />
        </AppTypography>
      </Stack>
...
export default memo(BoxDetailCard);
